        ...
        <div class="table-wrapper">
            <table class="fl-table">
                ...
                <tr>
                    ...
                    <td>
                        <img src="{{ url('storage/'.$value->image) }}" class="profilePic" alt="" width="100" height="50">
                    </td>

                    <td>
                    <a href=""><input class="btn btn-primary" type="submit" value="Edit"></a>
                    <a href=""><input class="btn btn-primary" type="submit" value="Delete"></a>
                </td>
                </tr>
                @endforeach
                <tbody>
